...
public class PruebasController {
    ...
    @PostMapping("/query4")
    public String consultaQuery4(@RequestParam(value = "descripcion") String texto,
             Model model) {
        var productos = productoService.findByDescription(texto);
        model.addAttribute("productos", productos);
        model.addAttribute("totalProductos", productos.size());
        model.addAttribute("descripcion", texto);
        return "/pruebas/listado3";
    }
}
